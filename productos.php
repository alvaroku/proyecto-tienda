...
<body class="">
	...
	<ul class="sidenav" id="mobile-demo">
	    ...
	    <li><a href="signup.html"><i class="material-icons">description</i>Registrarse</a></li>
	</ul>
		...
		<div class="section">
			<div class="row">
				...
				if($resultado->num_rows==0){
				     echo "<h1 class='center'>No hay productos para mostrar</h1>";
				}else{
				...
				<div class="col s12 m4 l4">
				      <div class="card">
				        <div class="card-image blue">
				          <img src="imgs/img<?php echo $row['id_prod'] ?>.png">
				          <span class="card-title"><?php echo $row['nombre'] ?></span>
				          
				        </div>
				        <div class="card-content">
				          <p><b>Precio:</b> $<?php echo $row['precio'] ?>.00</p>
				          <p><b>Disponibles:</b> <?php echo $row['existentes'] ?> unidades</p>
				          <p><b>Descripción:</b> <?php echo $row['descripcion'] ?></p>
				          <p ><b>Cantidad</b></p>

				          <form action="agregarCarrito.php" method="post">
				          	<select name="cantidad">
				          	  <?php for($i=1;$i<=$row['existentes'];$i++){
				          	  	?>
				          	...
				          	<input name="id_us" type="hidden" value="<?php echo $id_us ?>">
				          	<div class="row">
				          		<button class="btn blue col s12"><i class="material-icons">add_shopping_cart</i></button >
				          	</div>
				          </form>
